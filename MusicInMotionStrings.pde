//ver 1.6
//Music in Motion String Version 
...
void setup() {
  ...
  kinect.init();
  note[0] = new SoundFile(this, "Strings_03.mp3");
  note[1] = new SoundFile(this, "Strings_10.mp3");
  note[2] = new SoundFile(this, "Strings_28.mp3");
  note[3] = new SoundFile(this, "Strings_21.mp3");
  note[4] = new SoundFile(this, "Strings_19.mp3");
}
